...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '幻の梦 Gemn', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '初入嵌入式软件的牛犊', // 作者简介
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/Fa6SolidBlog.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
